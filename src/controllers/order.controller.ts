...
export const adminUpdateOrderStatus = asyncHandler(async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
export const uploadPaymentScreenshot = asyncHandler(async (req: AuthRequest, res: Response) => {
    const orderId = req.params.id;
    ...
    res.json({ 
        message: 'Screenshot uploaded successfully. We will verify your payment shortly.',
        order: order 
    });
});
